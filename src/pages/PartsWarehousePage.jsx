...
import { useDeletePart, useParts } from "@/app/hooks/useParts";
import { partTableSchema } from "@/app/tableSchemas/partTableSchema";
...
export function PartsWarehousePage() {
  ...
  return (
    <main className="flex w-full justify-center p-10">
        ...
        <EditModal className="sm:max-w-[880px] max-h-[90vh] flex flex-col" modalOpen={isEditModalOpen} onClose={closeEditModal} Form={<PartForm part={selectedPart} onClose={closeEditModal} />} />
    </main>
  );
}
